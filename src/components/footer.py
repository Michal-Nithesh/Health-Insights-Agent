...
from config.app_config import PRIMARY_COLOR, PRIMARY_LIGHT, SECONDARY_COLOR
import requests
import time
            ...
            '>
                ...
                ">
                    <a href='https://github.com/harshhh28/hia'
                       ...
                       onmouseout="this.style.color='{SECONDARY_COLOR}'; this.style.textDecoration='none'">
                        <span style="color: {PRIMARY_LIGHT};">Contribute to</span>
                        <svg height="12" width="12" viewBox="0 0 16 16" fill="{PRIMARY_LIGHT}">
