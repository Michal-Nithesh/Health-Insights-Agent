...
from config.app_config import ANALYSIS_DAILY_LIMIT, APP_ICON, APP_NAME
    ...
    with st.sidebar:
        st.markdown(
            ...
            <div style='display: flex; align-items: center; gap: 0.5rem; margin-bottom: 0.75rem;'>
                <span style='font-size: 1.3em;'>{APP_ICON}</span>
                <span style='font-weight: 600; font-size: 1.15em;'>{APP_NAME}</span>
            </div>
            """,
        ...
        st.markdown(
            f"""
            <div class='hia-card' style='
                padding: 0.6rem;
                margin: 0.5rem 0;
                text-align: center;
            '>
                <p style='margin: 0; color: #94A3B8; font-size: 0.85em;'>Daily Analysis Limit</p>
                <p style='
                    margin: 0.2rem 0 0 0;
                    color: {"#60A5FA" if remaining > 3 else "#FF4B4B"};
                    font-weight: 600;
                '>
